...
const PaymentForm = props => {
    const { handleOnStepChange, responsesDetails, onSave, minPremium, maxPremium, productId } = props;
    const initialValues = {
            ...
            <form onSubmit={formik.handleSubmit} encType="multipart/form-data" autoComplete="off">
                <Grid spacing={2} container alignItems={'center'} sx={{mt:1}}>
                    <Grid item sm={12} xs={12} md={5}>
                        <Grid container spacing={2}>
                            <Grid item xs={12} md={12} sm={12}>
                                <MKTypography color={'primary'} variant={'h4'}>Premium Details</MKTypography>
                            </Grid>
                            ...
                            <Grid item xs={12} sm={6} md={6}>
                                <DMTTextInput
                                    ...
                                    error={Boolean(formik?.touched.coverPremium && formik?.errors.coverPremium)}
                                    helperText={formik?.touched.coverPremium && formik?.errors.coverPremium}
                                    onBlur={formik.handleBlur}
                            ...
                            <Grid item xs={12} sm={6} md={6}>
                                <DMTTextInput
                                    ...
                                    error={Boolean(formik?.touched.policyFee && formik?.errors.policyFee)}
                                    helperText={formik?.touched.policyFee && formik?.errors.policyFee}
                                    onBlur={formik.handleBlur}
                            ...
                            <Grid item xs={12} sm={6} md={6}>
                                <DMTTextInput
                                    ...
                                    error={Boolean(formik?.touched.compensationLevy && formik?.errors.compensationLevy)}
                                    helperText={formik?.touched.compensationLevy && formik?.errors.compensationLevy}
                                    onBlur={formik.handleBlur}
                            ...
                            <TableContainer>
                                <Table sx={{
                                    ...
                                    <TableBody>
                                        ...
                                        <StyledTableRow>
                                            <StyledTableCell>Name: <b>{'Sanlam Life'}</b> </StyledTableCell>
                                            <StyledTableCell>
                                                <DMTBankBranches {...{
                                                    label:'Branch Name',
                                        ...
                                        <StyledTableRow>
                                            <StyledTableCell>Policy Number: <b>{'SC'}</b> </StyledTableCell>
                                        ...
                                        <StyledTableRow>
                                            <StyledTableCell>
                                                Bank Name: <b>{'Standard Chartered Bank'}</b>
                                            </StyledTableCell>
                                        </StyledTableRow>
                                        <StyledTableRow>
                                            <StyledTableCell>
                                                Bank Branch: <b>{'Kenyatta Avenue Branch'}</b>
                                            </StyledTableCell>
                                        </StyledTableRow>
                                        <StyledTableRow>
                                            <StyledTableCell>
                    ...
                    <Grid item sm={12}  xs={12} md={12}>
                        <MKBox mt={4}>
                            <MKTypography color={'primary'} variant={'h4'} gutterBottom>{'File Attachments'}</MKTypography>
                            <Grid container spacing={2}>
                    ...
                    <Grid item sm={12}  xs={12} md={12}>
                        <MKBox mt={4}>
                            <MKTypography color={'primary'} variant={'h4'}>{'Declaration'}</MKTypography>
