...
const sanlamEducareSlice = createSlice({
    name: 'sanlam-educare',
    initialState,
    reducers: {
...
} = sanlamEducareSlice.actions;

export const getQuestions = () => async dispatch => {
    const data = await commonApis.fetchSanlamEducareQuestions();
...
export const saveDetails = (section, customerId, productId, details, index=0) => async dispatch => {
    ...
    //         }
    //     }
    //     if (section === 'childDetails'){
    //         const values = {...details.childDetails[index]}
    //         const data = await commonApis.updateChildDetails(customerId, productId, values);
    //         //update the health details
    //         if (data?.id){
    //             details.childDetails[index] = {...data}
    //         }
    //     }
...
export default sanlamEducareSlice.reducer