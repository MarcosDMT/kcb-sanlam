...
const educarePLusSlice = createSlice({
    name: 'educare-plus',
    initialState,
    reducers: {
...
export const {
    ...
    setSectionCompleted,
    setProductId,
} = educarePLusSlice.actions;

export const getQuestions = () => async dispatch => {
    const data = await commonApis.fetchEducarePlusQuestions();
...
export default educarePLusSlice.reducer